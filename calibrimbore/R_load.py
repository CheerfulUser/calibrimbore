...
R = {'ps1': {'g': {'coeff': [ 3.61562687, -0.0891928 ],
	 ...
	 'decam': {'g': {'coeff': [ 3.61562687, -0.0891928 ],
				   'std': 0.004146827352467696},
		     'r': {'coeff': [ 2.58602003, -0.03325315],
			       'std': 0.0010620316190595924},
			 'i': {'coeff': [ 1.90959054, -0.01284678],
	...
	'gaia': {'r': {'coeff': [2.837906689873428, -0.7251441494838515], # actually G
			  	   'std': 0.028668930368166173},
			 'g': {'coeff': [3.430221015801683, -0.5133478010419253], # actually B
			  	   'std': 0.03485854302491111},
			 'i': {'coeff': [1.8878113460579364, -0.10670273663007716], # actually R
...
# hmm don't know how this works for gaia...
